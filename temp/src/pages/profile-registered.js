...
import styles from "./profile-registered.module.css";
...
const ProfileRegistered = () => {
  ...
  return (
    <div className={styles.profileRegistered}>
      <div className={styles.sl11302254210351} />
      <div className={styles.profileRegisteredChild} />
