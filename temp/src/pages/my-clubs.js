...
import styles from "./my-clubs.module.css";
...
const MyClubs = () => {
  ...
  const onIconArrowRight1Click = useCallback(() => {
    navigate("/explore-main");
  }, [navigate]);
  ...
  return (
    <div className={styles.myClubs}>
      ...
      <img
        ...
        onClick={onIconArrowRight1Click}
      />
      ...
      <div className={styles.frameGroup}>
        <div className={styles.frameWrapper}>
          ...
          >
            <b className={styles.exploreMoreClubs}>My Profile</b>
          </div>
        </div>
        <div className={styles.frameContainer}>
          <div className={styles.logOutWrapper}>
            <b className={styles.exploreMoreClubs}>Log Out</b>
          </div>
        </div>
      </div>
    </div>
