...
import styles from "./profile-participated-main.module.css";

const ProfileParticipatedMain = () => {
  ...
  const onIconProfileCircleClick = useCallback(() => {
    navigate("/profile-participated");
  }, [navigate]);

  return (
    <div className={styles.profileParticipatedMain}>
      <div className={styles.sl11302254210351} />
      <div className={styles.profileParticipatedMainChild} />
      ...
      <div className={styles.profileParticipatedMainItem} />
      <img
        className={styles.profileParticipatedMainInner}
        alt=""
...
export default ProfileParticipatedMain;
